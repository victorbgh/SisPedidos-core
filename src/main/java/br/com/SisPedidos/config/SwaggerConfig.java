...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.SisPedidos.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API Spring Boot",
		 "API DO SPRING BOOT DE SISTEMA DE PEDIDOS",
		 "Versão 1.0",
		 "https://www.victorhgb.com.br",
		 new Contact("Victor Hugo Gonçalves", "www.victorhgb.com.br", "victorhugo-brito@hotmail.com"),
		 "Informação",
		 "www.victorhgb.com.br",
