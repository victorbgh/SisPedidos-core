...
import br.com.SisPedidos.domain.PagamentoComCartao;
import br.com.SisPedidos.domain.Pedido;
import br.com.SisPedidos.domain.Produto;
import br.com.SisPedidos.domain.enums.EstadoPagamento;
import br.com.SisPedidos.domain.enums.Perfil;
import br.com.SisPedidos.domain.enums.TipoCliente;
import br.com.SisPedidos.repositories.CategoriaRepository;
import br.com.SisPedidos.repositories.CidadeRepository;
import br.com.SisPedidos.repositories.ClienteRepository;
import br.com.SisPedidos.repositories.EnderecoRepository;
...
import br.com.SisPedidos.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p7 = new Produto(null, "TV", 1180.00);
		Produto p8 = new Produto(null, "Roçadeira", 880.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "victorhugogoncalves2010@gmail.com", "05156463185",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("99595959", "34471154"));

		Cliente cli2 = new Cliente(null, "Ana costa", "victorhugo-brito@hotmail.com", "23883960187",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("99595959", "34471154"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "1233121", cli1, c1);

		Endereco e2 = new Endereco(null, "Avenida matos", "105", "Sala 800", "Centro", "70238200", cli1, c2);

		Endereco e3 = new Endereco(null, "Avenida floriano", "300", null, "Jardim", "70238200", cli2, c1);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 19:32"), cli1, e1);
